...
class UNet(nn.Module):
    def __init__(self, in_dim, out_dim, num_filters):
        ...
        self.down_5 = conv_block_2_3d(self.num_filters , self.num_filters , activation)
        self.pool_5 = max_pooling_3d()
        
        # Bridge
        self.bridge = conv_block_2_3d(self.num_filters , self.num_filters , activation)
        
        # Up sampling
        self.trans_1 = conv_trans_block_3d(self.num_filters , self.num_filters , activation)
        self.up_1 = conv_block_2_3d(self.num_filters*2 , self.num_filters , activation)
        self.trans_2 = conv_trans_block_3d(self.num_filters , self.num_filters , activation)
        self.up_2 = conv_block_2_3d(self.num_filters*2 , self.num_filters, activation)
        self.trans_3 = conv_trans_block_3d(self.num_filters , self.num_filters , activation)
        self.up_3 = conv_block_2_3d(self.num_filters*2 , self.num_filters , activation)
        self.trans_4 = conv_trans_block_3d(self.num_filters , self.num_filters , activation)
        self.up_4 = conv_block_2_3d(self.num_filters*2 , self.num_filters , activation)
        self.trans_5 = conv_trans_block_3d(self.num_filters , self.num_filters , activation)
